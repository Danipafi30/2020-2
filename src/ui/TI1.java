...
public class TI1{
    ...
    public static void main(String args[]){
        ...
        String[] materials = new String[MATERIALS];
        int[] amount = new int[MATERIALS];
        int[] usage = new int[MATERIALS];
        int[] priceHome = new int[MATERIALS];
        int[] priceCenter = new int[MATERIALS];
        int[] priceNeighbor = new int[MATERIALS];
        int blackW = 0;
        String[] blackWork = new String[blackW];
        int totalHome = 0;
        int totalCenter = 0;
        int totalNeighbor = 0;
        int totalBestProduct = 0;
        ...
        do{
            ...
            switch(off){
                case 1:
                msg = productNames(MATERIALS, materials, amount, usage);
                ...
                break;
                case 6:
                blackWork = blackWorkMaterials(materials, usage);
	...
	*/
    public static String productNames(int MATERIALS, String[] materials, int[] amount, int[] usage){
	...
	*/
    public static String[] blackWorkMaterials(String[] materials, int[] usage){
        int counter = 0;
        int newCounter = 0;
        int choose = 0;
